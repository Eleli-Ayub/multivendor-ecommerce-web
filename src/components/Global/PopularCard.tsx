...
function Productcard({ image, name, price, id }: productCard) {
    ...
    return (
        <div className="w-[47vw] md:w-[250px] rounded-xl p-0  h-[250px] lg:h-[280px] mb-2 cursor-pointer px-2 hover:bg-[whitesmoke] pb-3">
            <div
                className="flex h-full flex-col max-w-sm rounded-xl bg-none radius-2xl border-gray-300 mb-2 relative hover:scale-105 duration-300"
