...
function Productcard({ image, name, price, description, id }: productCard) {
    ...
    return (
        <div className="w-[45vw] md:w-72  rounded-xl p-0 lg:h-[350px] mb-2 cursor-pointer ">
            <div
                className="flex h-full flex-col max-w-sm rounded-xl bg-none  radius-2xl  border-gray-300 mb-2  relative lg:hover:bg-green-100 hover:scale-105 duration-300"
